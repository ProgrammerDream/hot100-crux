 ...
 * 勿手改；重建见 scripts/。共 370 张卡，覆盖 Hot100。
 */
window.CRUX_CARDS_VERSION = "2";
window.CRUX_CARDS = [
 {
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "auto it = hashtable.find(target - nums[i]); // 先查：我需要的另一半是否已出现\nif (it != hashtable.end()) {\n    return {it->second, i};\n}\n{{B}}",
 ...
 },
 {
  ...
  "problemId": 283,
  "problemTitle": "283. 移动零",
  "category": "双指针",
  "crux": "while循环边界必须是 right < n，不能等于n（越界）也不能少扫最后一个",
  "lang": "cpp",
  "code": "        int n = nums.size(), left = 0, right = 0;\n        while ({{B}}) {",
  "answer": "right < n",
  "options": [
   "right < n",
   "right <= n",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "                swap(nums[left], nums[right]); // 不变量：left 左边全非零且保持原相对顺序\n                left++;\n            }\n            {{B}}\n        }",
  "answer": "right++;",
  "options": [
   "right++;",
   "left++;",
 ...
 },
 {
  ...
  "problemId": 15,
  "problemTitle": "15. 三数之和",
  "category": "双指针",
  "crux": "外层去重条件 first > 0 && nums[first] == nums[first - 1]",
  "lang": "cpp",
  "code": "for (int first = 0; first < n; ++first) {\n    // 需要和上一次枚举的数不相同\n    if ({{B}}) {\n        continue;\n    }",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "for (int second = first + 1; second < n; ++second) {\n    // 需要和上一次枚举的数不相同\n    if ({{B}} && nums[second] == nums[second - 1]) {\n        continue;\n    }",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "while ({{B}} && nums[second] + nums[third] > target) {\n    --third;\n}",
  "answer": "second < third",
  "options": [
   "second < third",
   "second <= third",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if ({{B}}) { // 哪侧矮结算哪侧：此时 left 处水量只由 leftMax 决定\n                ans += leftMax - height[left];\n                ++left;\n            } else {\n                ans += rightMax - height[right];\n                --right;\n            }",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if (height[left] < height[right]) { // 哪侧矮结算哪侧：此时 left 处水量只由 leftMax 决定\n                ans += leftMax - {{B}};\n                ++left;",
  "answer": "height[left]",
  "options": [
   "height[left]",
   "height[right]",
 ...
 },
 {
  ...
  "problemId": 3,
  "problemTitle": "3. 无重复字符的最长子串",
  "category": "滑动窗口",
  "crux": "右指针 rk 的初始值必须是 -1（表示空窗口，尚未开始移动），不能写成 0 或 1",
  "lang": "cpp",
  "code": "unordered_set<char> occ;\nint n = s.size();\nint rk = {{B}}, ans = 0;",
  "answer": "-1",
  "options": [
   "-1",
   "0",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "// 第 i 到 rk 个字符是一个极长的无重复字符子串\nans = max(ans, {{B}});",
  "answer": "rk - i + 1",
  "options": [
   "rk - i + 1",
   "rk - i",
 ...
 },
 {
  ...
  "problemId": 438,
  "problemTitle": "438. 找到字符串中所有字母异位词",
  "category": "滑动窗口",
  "crux": "s 比 p 短时的提前返回条件用 < 还是 <=",
  "lang": "cpp",
  "code": "int sLen = s.size(), pLen = p.size();\n\nif (sLen {{B}} pLen) {\n    return vector<int>();\n}",
  "answer": "<",
  "options": [
   "<",
   "<=",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "for (int i = 0; i < sLen - pLen; ++i) {\n    --sCount[s[i] - 'a'];          // 窗口右移一格：左端字符移出\n    ++sCount[s[i + pLen] - 'a'];   // 右端字符移入\n    if (sCount == pCount) {\n        ans.emplace_back({{B}});\n    }\n}",
  "answer": "i + 1",
  "options": [
   "i + 1",
   "i",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "for (const auto &p: ori) {\n            if (cnt[p.first] {{B}} p.second) {\n                return false;\n            }\n        }\n        return true;",
  "answer": "<",
  "options": [
   "<",
   "<=",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "while (check() && l {{B}} r) { // 已覆盖时尽量收缩左边界，更新最短答案\n                if (r - l + 1 < len) {\n                    len = r - l + 1;\n                    ansL = l;\n                }",
  "answer": "<=",
  "options": [
   "<=",
   "<"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "pre = max({{B}}); // 以 x 结尾的最大子数组和：接上前一段或另起一段",
  "answer": "pre + x, x",
  "options": [
   "pre + x, x",
   "pre + x, 0",
 ...
 },
 {
  ...
  "problemId": 56,
  "problemTitle": "56. 合并区间",
  "category": "普通数组",
  "crux": "遍历区间的循环边界，写错会越界或漏处理最后一个区间",
  "lang": "cpp",
  "code": "for (int i = 0; i {{B}} intervals.size(); ++i) {\n    int L = intervals[i][0], R = intervals[i][1];",
  "answer": "<",
  "options": [
   "<",
   "<=",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if (!merged.size() || merged.back()[1] {{B}} L) {\n    merged.push_back({L, R});\n}",
  "answer": "<",
  "options": [
   "<",
   "<=",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "else {\n    merged.back()[1] = {{B}}; // 有重叠：右端点取较大者，处理区间包含\n}",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "    void reverse(vector<int>& nums, int start, int end) {\n        while ({{B}}) {\n            swap(nums[start], nums[end]);\n            start += 1;\n            end -= 1;\n        }\n    }",
  "answer": "start < end",
  "options": [
   "start < end",
   "start != end",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        reverse(nums, 0, nums.size() - 1); // 整体翻转后，再把前 k 个与后 n-k 个各自翻回\n        reverse(nums, 0, {{B}});\n        reverse(nums, k, nums.size() - 1);",
  "answer": "k - 1",
  "options": [
   "k - 1",
   "k",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        reverse(nums, 0, k - 1);\n        reverse(nums, {{B}}, nums.size() - 1);",
  "answer": "k",
  "options": [
   "k",
   "k + 1",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "for (int i = length - 1; i {{B}} 0; i--) {\n            answer[i] = answer[i] * R;\n            R *= nums[i];\n        }",
  "answer": ">=",
  "options": [
   ">=",
   ">"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "int num = abs(nums[i]);\nif (num <= n) {\n    nums[{{B}}] = -abs(nums[num - 1]); // 值 num 出现过：给下标 num-1 处打负号标记\n}",
  "answer": "num - 1",
  "options": [
   "num - 1",
   "num",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "int num = abs(nums[i]);\nif (num <= n) {\n    nums[num - 1] = {{B}}; // 值 num 出现过：给下标 num-1 处打负号标记\n}",
 ...
 },
 {
  ...
  "problemId": 73,
  "problemTitle": "73. 矩阵置零",
  "category": "矩阵",
  "crux": "flag_col0/flag_row0 必须初始化为 false，等待后续扫描后才置为 true",
  "lang": "cpp",
  "code": "int flag_col0 = {{B}}, flag_row0 = false; // 先记录第一列 / 第一行自身是否含 0",
  "answer": "false",
  "options": [
   "false",
   "true"
 ...
 },
 {
  ...
  "problemId": 54,
  "problemTitle": "54. 螺旋矩阵",
  "category": "矩阵",
  "crux": "外层循环条件必须是 left<=right && top<=bottom（等号），否则最后一行/一列不会被遍历",
  "lang": "cpp",
  "code": "int left = 0, right = columns - 1, top = 0, bottom = rows - 1;\nwhile ({{B}}) {\n    for (int column = left; column <= right; column++) {\n        order.push_back(matrix[top][column]);\n    }",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "for (int row = {{B}}; row <= bottom; row++) {\n    order.push_back(matrix[row][right]);\n}",
  "answer": "top + 1",
  "options": [
   "top + 1",
   "top",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if ({{B}}) { // 该层至少两行两列才走下边和左边，防单行/单列重复\n    for (int column = right - 1; column > left; column--) {\n        order.push_back(matrix[bottom][column]);\n    }",
  "answer": "left < right && top < bottom",
  "options": [
   "left < right && top < bottom",
   "left <= right && top <= bottom",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "for (int column = {{B}}; column > left; column--) {\n    order.push_back(matrix[bottom][column]);\n}",
  "answer": "right - 1",
  "options": [
   "right - 1",
   "right",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "for (int row = {{B}}; row > top; row--) {\n    order.push_back(matrix[row][left]);\n}",
  "answer": "bottom",
  "options": [
   "bottom",
   "bottom - 1",
 ...
 },
 {
  ...
  "problemId": 240,
  "problemTitle": "240. 搜索二维矩阵 II",
  "category": "矩阵",
  "crux": "起点必须选在右上角 (0, n-1)，这样该位置同时是本行最大值、本列最小值，才能保证每次比较都能唯一排除一整行或一整列",
  "lang": "cpp",
  "code": "int m = matrix.size(), n = matrix[0].size();\nint x = 0, y = {{B}}; // 从右上角出发：它是本行最大、本列最小\nwhile (x < m && y >= 0) {",
  "answer": "n - 1",
  "options": [
   "n - 1",
   "0",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "pA = pA == nullptr ? {{B}} : pA->next; // 走完 A 接着走 B：两指针总路程同为 a+b，抹平长度差",
  "answer": "headB",
  "options": [
   "headB",
   "headA",
 ...
 },
 {
  ...
  "problemId": 206,
  "problemTitle": "206. 反转链表",
  "category": "链表",
  "crux": "prev 必须初始化为 nullptr，代表反转链表的末尾（新链表终点）",
  "lang": "cpp",
  "code": "ListNode* prev = {{B}};\n        ListNode* curr = head;",
  "answer": "nullptr",
  "options": [
   "nullptr",
   "head",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "            slow = slow->next;\n            fast = {{B}}; // 快指针每次两步，有环时相对慢指针每步逼近 1，必相遇",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "                ListNode *ptr = {{B}}; // 相遇后：从头出发的指针与 slow 同速走，恰在入环口相遇\n                while (ptr != slow) {",
  "answer": "head",
  "options": [
   "head",
   "slow",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "                ListNode *ptr = head; // 相遇后：从头出发的指针与 slow 同速走，恰在入环口相遇\n                while ({{B}}) {\n                    ptr = ptr->next;\n                    slow = slow->next;\n                }\n                return ptr;",
  "answer": "ptr != slow",
  "options": [
   "ptr != slow",
   "ptr == slow",
 ...
 },
 {
  ...
  "problemId": 21,
  "problemTitle": "21. 合并两个有序链表",
  "category": "链表",
  "crux": "while循环条件必须用&&而非||，否则某条链表已空时会解引用空指针",
  "lang": "cpp",
  "code": "while (l1 != nullptr {{B}} l2 != nullptr) {\n    if (l1->val < l2->val) {",
  "answer": "&&",
  "options": [
   "&&",
   "||"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "            if (!head) {\n                head = tail = new ListNode(sum {{B}} 10);\n",
  "answer": "%",
  "options": [
   "%",
   "/"
 ...
 },
 {
  ...
  "problemId": 19,
  "problemTitle": "19. 删除链表的倒数第 N 个结点",
  "category": "链表",
  "crux": "second 指针必须从哨兵 dummy 出发，而不是从 head 出发",
  "lang": "cpp",
  "code": "ListNode* first = head;\nListNode* second = {{B}};",
  "answer": "dummy",
  "options": [
   "dummy",
   "head",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "for (int i = 0; i {{B}} n; ++i) { // first 先走 n 步，保持与 second 间距为 n\n    first = first->next;\n}",
  "answer": "<",
  "options": [
   "<",
   "<=",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "second->next = {{B}}; // 此时 second 恰是待删节点的前驱",
 ...
 },
 {
  ...
  "problemId": 24,
  "problemTitle": "24. 两两交换链表中的节点",
  "category": "链表",
  "crux": "循环条件必须同时保证两个节点都非空，用 && 而不是 ||",
  "lang": "cpp",
  "code": "while (temp->next != nullptr {{B}} temp->next->next != nullptr) {",
  "answer": "&&",
  "options": [
   "&&",
   "||"
 ...
 },
 {
  ...
  "problemId": 25,
  "problemTitle": "25. K 个一组翻转链表",
  "category": "链表",
  "crux": "反转循环用 prev != tail（而非 p != tail）作为终止条件，因为 prev 比 p 慢一步",
  "lang": "cpp",
  "code": "ListNode* prev = tail->next;\nListNode* p = head;\n{{B}} {\n    ListNode* nex = p->next;\n    p->next = prev;\n    prev = p;\n    p = nex;\n}\nreturn {tail, head};",
 ...
 },
 {
  ...
  "problemId": 148,
  "problemTitle": "148. 排序链表",
  "category": "链表",
  "crux": "递归终止时判断“区间只剩一个节点”，比较对象必须是 tail 而不是 nullptr 或 head 本身",
  "lang": "cpp",
  "code": "if ({{B}}) { // 区间 [head, tail) 只剩单个节点：断链后返回\n    head->next = nullptr;\n    return head;\n}",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if (head->next == tail) { // 区间 [head, tail) 只剩单个节点：断链后返回\n    {{B}}\n    return head;\n}",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "    ListNode* merge(vector <ListNode*> &lists, int l, int r) {\n        if ({{B}}) return lists[l];\n        if (l > r) return nullptr;",
  "answer": "l == r",
  "options": [
   "l == r",
   "l >= r",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        int mid = (l + r) >> 1; // 对半劈开两两合并，每条链只被合并 O(log k) 次\n        return mergeTwoLists(merge(lists, l, mid), merge(lists, {{B}}, r));",
  "answer": "mid + 1",
  "options": [
   "mid + 1",
   "mid",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "    void moveToHead(DLinkedNode* node) {\n        {{B}}\n        addToHead(node);\n    }",
 ...
 },
 {
  ...
  "problemId": 104,
  "problemTitle": "104. 二叉树的最大深度",
  "category": "二叉树",
  "crux": "递归出口空节点的深度必须是 0，不能写成 1 或 -1，否则整体深度会多算或少算一层",
  "lang": "cpp",
  "code": "if (root == nullptr) return {{B}};",
  "answer": "0",
  "options": [
   "0",
   "1",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "return max(maxDepth(root->left), maxDepth(root->right)) {{B}};",
  "answer": "+ 1",
  "options": [
   "+ 1",
   "+ 0",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "TreeNode* left = invertTree({{B}}); // 先递归翻转两棵子树，再交换挂回当前节点\nTreeNode* right = invertTree(root->right);\nroot->left = right;\nroot->right = left;\nreturn root;",
  "answer": "root->left",
  "options": [
   "root->left",
   "root->right",
 ...
 },
 {
  ...
  "problemId": 101,
  "problemTitle": "101. 对称二叉树",
  "category": "二叉树",
  "crux": "两个节点都为空才判定对称为 true，写成 || 会把「一空一非空」误判为对称",
  "lang": "cpp",
  "code": "if ({{B}}) return true;\n        if (!p || !q) return false;",
  "answer": "!p && !q",
  "options": [
   "!p && !q",
   "!p || !q",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "return p->val == q->val && {{B}} && check(p->right, q->left); // 镜像：左对右、右对左交叉比较",
 ...
 },
 {
  ...
  "problemId": 543,
  "problemTitle": "543. 二叉树的直径",
  "category": "二叉树",
  "crux": "空节点深度基准值应为 0，不是 1 或负数",
  "lang": "cpp",
  "code": "if (rt == NULL) {\n    return {{B}}; // 访问到空节点了，返回0\n}",
  "answer": "0",
  "options": [
   "0",
   "1",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "int L = depth(rt->left); // 左儿子为根的子树的深度\nint R = depth(rt->right); // 右儿子为根的子树的深度\nans = max(ans, {{B}}); // 计算d_node即L+R+1 并更新ans",
  "answer": "L + R + 1",
  "options": [
   "L + R + 1",
   "L + R",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "return max(L, R) + {{B}}; // 返回该节点为根的子树的深度",
  "answer": "1",
  "options": [
   "1",
   "0",
 ...
 },
 {
  ...
  "problemId": 102,
  "problemTitle": "102. 二叉树的层序遍历",
  "category": "二叉树",
  "crux": "必须在循环开始前用变量快照队列长度，而不能在循环条件里动态调用 q.size()",
  "lang": "cpp",
  "code": "int currentLevelSize = q.size(); // 不变量：此刻队列里恰好是当前层的全部节点\n            ret.push_back(vector <int> ());\n            for (int i = 1; i <= {{B}}; ++i) {",
 ...
 },
 {
  ...
  "problemId": 108,
  "problemTitle": "108. 将有序数组转换为二叉搜索树",
  "category": "二叉树",
  "crux": "初始调用的右边界必须是 size()-1,不能多1或少1",
  "lang": "cpp",
  "code": "return helper(nums, 0, {{B}});",
  "answer": "nums.size() - 1",
  "options": [
   "nums.size() - 1",
   "nums.size()",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "root->left = helper(nums, left, {{B}});",
  "answer": "mid - 1",
  "options": [
   "mid - 1",
   "mid",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "root->right = helper(nums, {{B}}, right);",
  "answer": "mid + 1",
  "options": [
   "mid + 1",
   "mid",
 ...
 },
 {
  ...
  "problemId": 98,
  "problemTitle": "98. 验证二叉搜索树",
  "category": "二叉树",
  "crux": "下界比较必须用 <= 而非 <,以判定等值也非法(BST 不允许重复值落在同一开区间边界)",
  "lang": "cpp",
  "code": "bool helper(TreeNode* root, long long lower, long long upper) {\n    if (root == nullptr) {\n        return true;\n    }\n    if (root -> val {{B}} lower || root -> val >= upper) { // 节点值必须严格落在开区间 (lower, upper) 内\n        return false;\n    }",
  "answer": "<=",
  "options": [
   "<=",
   "<"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if (root -> val <= lower || root -> val {{B}} upper) { // 节点值必须严格落在开区间 (lower, upper) 内\n        return false;\n    }",
  "answer": ">=",
  "options": [
   ">=",
   ">"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "return helper(root -> left, {{B}}) && helper(root -> right, root -> val, upper);",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "return helper(root -> left, lower, root -> val) && helper(root -> right, {{B}});",
 ...
 },
 {
  ...
  "problemId": 230,
  "problemTitle": "230. 二叉搜索树中第 K 小的元素",
  "category": "二叉树",
  "crux": "外层循环条件必须用 || 而不是 &&，因为root耗尽和栈耗尽是两个独立的“还没走完”标志",
  "lang": "cpp",
  "code": "while (root != nullptr {{B}} stack.size() > 0) {\n    while (root != nullptr) {\n        stack.push(root);\n        root = root->left;\n    }\n    root = stack.top();\n    stack.pop();",
  "answer": "||",
  "options": [
   "||",
   "&&"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "--k; // 弹栈顺序即中序递增顺序，第 k 次弹出的就是第 k 小\n    if (k == {{B}}) {\n        break;\n    }",
  "answer": "0",
  "options": [
   "0",
   "1"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "TreeNode* node = nodeQueue.front();nodeQueue.pop();\n            int depth = depthQueue.front();depthQueue.pop();\n\n            if (node {{B}} NULL) {",
  "answer": "!=",
  "options": [
   "!=",
   "=="
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "vector<int> rightView;\n        for (int depth = 0; depth {{B}} max_depth; ++depth) {\n            rightView.push_back(rightmostValueAtDepth[depth]);\n        }",
  "answer": "<=",
  "options": [
   "<=",
   "<"
 ...
 },
 {
  ...
  "problemId": 114,
  "problemTitle": "114. 二叉树展开为链表",
  "category": "二叉树",
  "crux": "重连循环必须从 i=1 开始，保证 i-1 不越界且能连上所有相邻节点对",
  "lang": "cpp",
  "code": "int n = l.size();\n        for (int i = {{B}}; i < n; i++) { // 按前序顺序把相邻节点重连成右斜单链\n            TreeNode *prev = l.at(i - 1), *curr = l.at(i);",
  "answer": "1",
  "options": [
   "1",
   "0",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "void preorderTraversal(TreeNode* root, vector<TreeNode*> &l) {\n        if (root {{B}} NULL) {\n            l.push_back(root);\n            preorderTraversal(root->left, l);\n            preorderTraversal(root->right, l);\n        }\n    }",
  "answer": "!=",
  "options": [
   "!=",
   "==",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "l.push_back(root);\n            preorderTraversal({{B}}, l);\n            preorderTraversal(root->right, l);",
  "answer": "root->left",
  "options": [
   "root->left",
   "root->right",
 ...
 },
 {
  ...
  "problemId": 105,
  "problemTitle": "105. 从前序与中序遍历序列构造二叉树",
  "category": "二叉树",
  "crux": "递归出口判断空区间用 >，不能写成 >=",
  "lang": "cpp",
  "code": "        if (preorder_left {{B}} preorder_right) {\n            return nullptr;\n        }",
  "answer": ">",
  "options": [
   ">",
   ">=",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        root->left = myBuildTree(preorder, inorder, preorder_left + 1, {{B}}, inorder_left, inorder_root - 1);",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        root->left = myBuildTree(preorder, inorder, preorder_left + 1, preorder_left + size_left_subtree, inorder_left, {{B}});",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        root->right = myBuildTree(preorder, inorder, {{B}}, preorder_right, inorder_root + 1, inorder_right);",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        root->right = myBuildTree(preorder, inorder, preorder_left + size_left_subtree + 1, preorder_right, {{B}}, inorder_right);",
  "answer": "inorder_root + 1",
  "options": [
   "inorder_root + 1",
   "inorder_root",
 ...
 },
 {
  ...
  "problemId": 437,
  "problemTitle": "437. 路径总和 III",
  "category": "二叉树",
  "crux": "prefix[0] 初始化值必须是 1,兜住从根节点直接出发的路径",
  "lang": "cpp",
  "code": "    int pathSum(TreeNode* root, int targetSum) {\n        prefix[0] = {{B}};\n        return dfs(root, 0, targetSum);\n    }",
  "answer": "1",
  "options": [
   "1",
   "0",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        int ret = 0;\n        curr += root->val;\n        if (prefix.count(curr - targetSum)) {\n            ret = prefix[{{B}}]; // 链上旧前缀和的个数 = 以当前节点结尾的合法路径数\n        }",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "    unordered_map<long long, int> prefix;\n\n    int dfs(TreeNode *root, {{B}} curr, int targetSum) {",
  "answer": "long long",
  "options": [
   "long long",
   "int",
 ...
 },
 {
  ...
  "problemId": 236,
  "problemTitle": "236. 二叉树的最近公共祖先",
  "category": "二叉树",
  "crux": "空节点的 dfs 返回值必须是 false，不能是 true",
  "lang": "cpp",
  "code": "bool dfs(TreeNode* root, TreeNode* p, TreeNode* q) {\n    if (root == nullptr) return {{B}};",
  "answer": "false",
  "options": [
   "false",
   "true"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if (({{B}}) || ((root->val == p->val || root->val == q->val) && (lson || rson))) {\n    ans = root;",
  "answer": "lson && rson",
  "options": [
   "lson && rson",
   "lson || rson"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if ((lson && rson) || ((root->val == p->val || root->val == q->val) && ({{B}}))) {\n    ans = root;",
  "answer": "lson || rson",
  "options": [
   "lson || rson",
   "lson && rson"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "return {{B}}; // 返回：该子树是否包含 p 或 q",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "int leftGain = max(maxGain(node->left), 0);\n        int rightGain = max(maxGain(node->right), {{B}});",
  "answer": "0",
  "options": [
   "0",
   "1",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if (r - 1 {{B}} && grid[r-1][c] == '1') dfs(grid, r - 1, c);\n        if (r + 1 < nr && grid[r+1][c] == '1') dfs(grid, r + 1, c);",
  "answer": ">= 0",
  "options": [
   ">= 0",
   "> 0"
 ...
 },
 {
  ...
  "problemId": 994,
  "problemTitle": "994. 腐烂的橘子",
  "category": "图论",
  "crux": "用 ~dis[tx][ty] 判断格子是否已访问（-1 取反为 0/假，其余取反为非 0/真）",
  "lang": "cpp",
  "code": "if (tx < 0|| tx >= n || ty < 0|| ty >= m || {{B}} || !grid[tx][ty]) { // 越界 / 已访问(~dis 非零) / 空格子都跳过\n    continue;\n}",
  "answer": "~dis[tx][ty]",
  "options": [
   "~dis[tx][ty]",
   "dis[tx][ty] == -1",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if ({{B}} || ty < 0|| ty >= m || ~dis[tx][ty] || !grid[tx][ty]) {\n    continue;\n}",
  "answer": "tx < 0|| tx >= n",
  "options": [
   "tx < 0|| tx >= n",
   "tx <= 0|| tx >= n",
 ...
 },
 {
  ...
  "problemId": 207,
  "problemTitle": "207. 课程表",
  "category": "图论",
  "crux": "邻接表建边时，先修课/后续课的下标方向容易写反",
  "lang": "cpp",
  "code": "for (const auto& info: prerequisites) {\n    edges[{{B}}].push_back(info[0]); // 先修课指向后续课\n    ++indeg[info[0]];\n}",
  "answer": "info[1]",
  "options": [
   "info[1]",
   "info[0]"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "for (int i = 0; i < numCourses; ++i) {\n    if (indeg[i] {{B}} 0) {\n        q.push(i);\n    }\n}",
  "answer": "==",
  "options": [
   "==",
   ">",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "return visited {{B}} numCourses; // 全部课都能出队 ⇔ 图中无环",
  "answer": "==",
  "options": [
   "==",
   "!="
 ...
 },
 {
  ...
  "problemId": 208,
  "problemTitle": "208. 实现 Trie (前缀树)",
  "category": "图论",
  "crux": "字符转子节点下标时用 'a' 做基准偏移",
  "lang": "cpp",
  "code": "for (char ch : prefix) {\n    {{B}}\n    if (node->children[ch] == nullptr) {\n        return nullptr;\n    }\n    node = node->children[ch];\n}",
  "answer": "ch -= 'a';",
  "options": [
   "ch -= 'a';",
   "ch -= 'A';",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "bool startsWith(string prefix) {\n    return {{B}};\n}",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        t.push_back(nums[cur]); // 选择当前元素\n        dfs({{B}}, nums);\n        t.pop_back(); // 撤销选择\n        dfs(cur + 1, nums); // 不选当前元素",
  "answer": "cur + 1",
  "options": [
   "cur + 1",
   "cur",
 ...
 },
 {
  ...
  "problemId": 17,
  "problemTitle": "17. 电话号码的字母组合",
  "category": "回溯",
  "crux": "digits 为空时必须直接返回空数组，不能继续走回溯（否则会得到含一个空串的错误结果）",
  "lang": "cpp",
  "code": "vector<string> combinations;\nif ({{B}}) {\n    return combinations;\n}",
  "answer": "digits.empty()",
  "options": [
   "digits.empty()",
   "digits.size() == 1",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "combination.push_back(letter);\nbacktrack(combinations, phoneMap, digits, {{B}}, combination);\ncombination.pop_back();",
  "answer": "index + 1",
  "options": [
   "index + 1",
   "index",
 ...
 },
 {
  ...
  "crux": "跳过分支必须推进 idx",
  "lang": "cpp",
  "code": "        // 直接跳过\n        dfs(candidates, target, ans, combine, {{B}});",
  "answer": "idx + 1",
  "options": [
   "idx + 1",
   "idx",
 ...
 },
 {
  ...
  "crux": "选择分支的边界须含 0",
  "lang": "cpp",
  "code": "        if (target - candidates[idx] {{B}}) {",
  "answer": ">= 0",
  "options": [
   ">= 0",
   "> 0",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "            combine.emplace_back(candidates[idx]);\n            dfs(candidates, target - candidates[idx], ans, combine, {{B}});\n            combine.pop_back();",
  "answer": "idx",
  "options": [
   "idx",
   "idx + 1",
 ...
 },
 {
  ...
  "problemId": 22,
  "problemTitle": "22. 括号生成",
  "category": "回溯",
  "crux": "右括号只能在 close < open 时放",
  "lang": "cpp",
  "code": "        if ({{B}}) { // 右括号不能多于左括号，保证前缀合法\n            cur.push_back(')');\n            backtrack(ans, cur, open, close + 1, n);\n            cur.pop_back();\n        }",
  "answer": "close < open",
  "options": [
   "close < open",
   "close <= open",
 ...
 },
 {
  ...
  "problemId": 79,
  "problemTitle": "79. 单词搜索",
  "category": "回溯",
  "crux": "判断整个单词匹配完成的下标条件",
  "lang": "cpp",
  "code": "        if (board[i][j] != s[k]) {\n            return false;\n        } else if (k == {{B}}) {\n            return true;\n        }",
  "answer": "s.length() - 1",
  "options": [
   "s.length() - 1",
   "s.length()",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "            int newi = i + dir.first, newj = j + dir.second;\n            if ({{B}} && newi < board.size() && newj >= 0 && newj < board[0].size()) {",
  "answer": "newi >= 0",
  "options": [
   "newi >= 0",
   "newi > 0",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "                bool flag = check(board, visited, i, j, word, {{B}});",
  "answer": "0",
  "options": [
   "0",
   "1",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "f.assign(n, vector<int>(n, {{B}}));",
  "answer": "true",
  "options": [
   "true",
   "false",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "                diagonals1.insert(diagonal1);\n                diagonals2.insert(diagonal2);\n                backtrack(solutions, queens, n, {{B}}, columns, diagonals1, diagonals2);\n                queens[row] = -1;",
  "answer": "row + 1",
  "options": [
   "row + 1",
   "row",
 ...
 },
 {
  "id": "p35-ans-init-n",
  "problemId": 35,
  "problemTitle": "35. 搜索插入位置",
  "category": "二分查找",
  "crux": "ans 初值必须设为 n，表示所有元素都比 target 小时插入到末尾",
  "lang": "cpp",
  "code": "int n = nums.size();\n        int left = 0, right = n - 1, ans = {{B}}; // ans 初值 n：全部元素都小于 target 时插在末尾",
  "answer": "n",
  "options": [
   "n",
   "n - 1",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "int n = nums.size();\n        int left = 0, right = {{B}}, ans = n; // ans 初值 n：全部元素都小于 target 时插在末尾",
  "answer": "n - 1",
  "options": [
   "n - 1",
   "n",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if ({{B}}) { // 找第一个 >= target 的位置：满足就记下并继续向左\n                ans = mid;\n                right = mid - 1;",
 ...
 },
 {
  ...
  "problemId": 74,
  "problemTitle": "74. 搜索二维矩阵",
  "category": "二分查找",
  "crux": "闭区间二分循环条件必须是 low <= high",
  "lang": "cpp",
  "code": "int low = 0, high = m * n - 1;\n{{B}}\n    int mid = (high - low) / 2 + low;",
 ...
 },
 {
  ...
  "problemId": 34,
  "problemTitle": "34. 在排序数组中查找元素的第一个和最后一个位置",
  "category": "二分查找",
  "crux": "二分查找主循环条件必须是 left <= right（闭区间收缩需覆盖 left==right 的情形）",
  "lang": "cpp",
  "code": "        int left = 0, right = (int)nums.size() - 1, ans = (int)nums.size();\n        while ({{B}}) {\n            int mid = (left + right) / 2;",
  "answer": "left <= right",
  "options": [
   "left <= right",
   "left < right"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        int left = 0, right = (int)nums.size() - 1, ans = {{B}};",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "            if (nums[mid] > target || (lower && nums[mid] >= target)) { // lower=true 找第一个 >= target，否则找第一个 > target\n                right = {{B}};\n                ans = mid;\n            } else {",
  "answer": "mid - 1",
  "options": [
   "mid - 1",
   "mid",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        int leftIdx = binarySearch(nums, target, true);\n        int rightIdx = binarySearch(nums, target, false) {{B}};",
  "answer": "- 1",
  "options": [
   "- 1",
   "+ 1"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        if ({{B}} && rightIdx < nums.size() && nums[leftIdx] == target && nums[rightIdx] == target) {\n            return vector<int>{leftIdx, rightIdx};\n        }",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if (nums[0] <= nums[mid]) { // 左半 [0, mid] 有序\n                if ({{B}} && target < nums[mid]) {\n                    r = mid - 1;\n                } else {\n                    l = mid + 1;\n                }",
 ...
 },
 {
  ...
  "problemId": 153,
  "problemTitle": "153. 寻找旋转排序数组中的最小值",
  "category": "二分查找",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if (nums[pivot] < nums[high]) {\n    {{B}} // pivot 可能就是最小值，不能减一",
  "answer": "high = pivot;",
  "options": [
   "high = pivot;",
   "high = pivot - 1;",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "else {\n    {{B}} // nums[pivot] >= nums[high]，最小值一定在 pivot 右侧",
  "answer": "low = pivot + 1;",
  "options": [
   "low = pivot + 1;",
   "low = pivot;",
 ...
 },
 {
  ...
  "problemId": 4,
  "problemTitle": "4. 寻找两个正序数组的中位数",
  "category": "二分查找",
  "crux": "新下标裁剪上界必须是 m - 1（数组合法下标上限），不能写成 m",
  "lang": "cpp",
  "code": "int newIndex1 = min(index1 + k / 2 - 1, {{B}});",
  "answer": "m - 1",
  "options": [
   "m - 1",
   "m",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if (totalLength % 2 == 1) {\n            return getKthElement(nums1, nums2, {{B}});\n        }",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "else {\n            return (getKthElement(nums1, nums2, totalLength / 2) + getKthElement(nums1, nums2, totalLength / 2 + 1)) / {{B}};\n        }",
  "answer": "2.0",
  "options": [
   "2.0",
   "2"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if (pairs.count(ch)) {\n    if ({{B}}) { // 栈顶必须恰是当前右括号对应的左括号\n        return false;\n    }\n    stk.pop();\n}",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "    void push(int x) {\n        x_stack.push(x);\n        min_stack.push({{B}}); // 不变量：辅助栈顶 == 当前栈内最小值\n    }",
 ...
 },
 {
  ...
  "problemId": 394,
  "problemTitle": "394. 字符串解码",
  "category": "栈",
  "crux": "getDigits 读取多位数字时必须用 while 循环连续读完所有数字字符，若只判断一次会漏读多位数字",
  "lang": "cpp",
  "code": "    string getDigits(string &s, size_t &ptr) {\n        string ret = \"\";\n        {{B}}\n            ret.push_back(s[ptr++]);\n        }\n        return ret;\n    }",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "                // 此时栈顶为当前 sub 对应的字符串应该出现的次数\n                {{B}}\n                stk.pop_back();",
 ...
 },
 {
  ...
  "problemId": 739,
  "problemTitle": "739. 每日温度",
  "category": "栈",
  "crux": "单调栈弹栈条件必须是严格大于，否则相等温度会被误判",
  "lang": "cpp",
  "code": "            while (!s.empty() && temperatures[i] {{B}} temperatures[s.top()]) {",
  "answer": ">",
  "options": [
   ">",
   ">=",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "                int previousIndex = s.top();\n                ans[previousIndex] = i - {{B}}; // i 是它右边第一个更高温度的下标\n                s.pop();",
 ...
 },
 {
  ...
  "problemId": 84,
  "problemTitle": "84. 柱状图中最大的矩形",
  "category": "栈",
  "crux": "左边没有更矮柱子时，left[i] 必须记为 -1（哨兵值），这样宽度公式 right-left-1 才能算出延伸到数组最左端",
  "lang": "cpp",
  "code": "left[i] = (mono_stack.empty() ? {{B}} : mono_stack.top()); // 左边第一个高度小于它的下标，不存在记 -1",
  "answer": "-1",
  "options": [
   "-1",
   "0",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "right[i] = (mono_stack.empty() ? {{B}} : mono_stack.top()); // 右边第一个高度小于它的下标，不存在记 n",
  "answer": "n",
  "options": [
   "n",
   "n - 1",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "ans = max(ans, (right[i] - left[i] {{B}}) * heights[i]); // 以 heights[i] 为高能延伸的宽度",
  "answer": "- 1",
  "options": [
   "- 1",
   "+ 1",
 ...
 },
 {
  ...
  "problemId": 215,
  "problemTitle": "215. 数组中的第K个最大元素",
  "category": "堆",
  "crux": "Hoare划分中 i 的初始偏移量为什么必须是 l-1",
  "lang": "cpp",
  "code": "        int partition = nums[l], i = {{B}}, j = r + 1;",
  "answer": "l - 1",
  "options": [
   "l - 1",
   "l",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        int partition = nums[l], i = l - 1, j = {{B}};",
  "answer": "r + 1",
  "options": [
   "r + 1",
   "r",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        int n = nums.size();\n        return quickselect(nums, 0, n - 1, {{B}}); // 第 k 大 = 升序排列后下标 n-k 的元素",
  "answer": "n - k",
  "options": [
   "n - k",
   "k - 1",
 ...
 },
 {
  ...
  "problemId": 347,
  "problemTitle": "347. 前 K 个高频元素",
  "category": "堆",
  "crux": "比较函数 m.second 与 n.second 的方向决定了这是小顶堆还是大顶堆",
  "lang": "cpp",
  "code": "static bool cmp(pair<int, int>& m, pair<int, int>& n) {\n    return m.second {{B}} n.second; // 按出现次数比较，构成小顶堆\n}",
  "answer": ">",
  "options": [
   ">",
   "<",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if (q.top().second {{B}} count) { // 堆顶是 k 个候选里频率最小的，被更高频的替换\n    q.pop();\n    q.emplace(num, count);\n}",
  "answer": "<",
  "options": [
   "<",
   ">",
 ...
 },
 {
  ...
  "problemId": 295,
  "problemTitle": "295. 数据流的中位数",
  "category": "堆",
  "crux": "addNum 条件判断中，queMin.empty() 必须写在 || 左边，靠短路先挡住空堆",
  "lang": "cpp",
  "code": "    void addNum(int num) {\n        if ({{B}}) {\n            queMin.push(num);",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "    double findMedian() {\n        if (queMin.size() > queMax.size()) {\n            return queMin.top();\n        }\n        return (queMin.top() + queMax.top()) / {{B}};\n    }",
  "answer": "2.0",
  "options": [
   "2.0",
   "2",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "rightmost = max(rightmost, i + nums[i]);\nif ({{B}}) {\n    return true;\n}",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "int n = nums.size();\nint rightmost = {{B}}; // 目前可达的最远下标，不变量：所有 <= rightmost 的位置都可达",
  "answer": "0",
  "options": [
   "0",
   "nums[0]",
 ...
 },
 {
  ...
  "problemId": 45,
  "problemTitle": "45. 跳跃游戏 II",
  "category": "贪心算法",
  "crux": "循环边界必须是 n - 1（不访问最后一个下标），否则恰好跳到终点那次会多算一步",
  "lang": "cpp",
  "code": "int maxPos = 0, n = nums.size(), end = 0, step = 0;\nfor (int i = 0; i < {{B}}; ++i) {\n    if (maxPos >= i) {\n        maxPos = max(maxPos, i + nums[i]);\n        if (i == end) {\n            end = maxPos;\n            ++step;\n        }\n    }\n}",
  "answer": "n - 1",
  "options": [
   "n - 1",
   "n",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "maxPos = max(maxPos, i + nums[i]);\nif ({{B}}) { // 当前这一层走完，必须再跳一步\n    end = maxPos;\n    ++step;\n}",
  "answer": "i == end",
  "options": [
   "i == end",
   "i == maxPos",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "int first = nums[0], second = max(nums[0], {{B}}); // first=dp[i-2]，second=dp[i-1]",
  "answer": "nums[1]",
  "options": [
   "nums[1]",
   "nums[0]",
 ...
 },
 {
  ...
  "problemId": 322,
  "problemTitle": "322. 零钱兑换",
  "category": "动态规划",
  "crux": "不可达标记值的初始化必须是 amount+1，既要大到不会被任何合法解覆盖，又不能大到溢出",
  "lang": "cpp",
  "code": "int Max = amount + 1;\nvector<int> dp(amount + 1, {{B}});",
  "answer": "amount + 1",
  "options": [
   "amount + 1",
   "amount",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "return dp[amount] {{B}} amount ? -1 : dp[amount];",
  "answer": ">",
  "options": [
   ">",
   ">=",
 ...
 },
 {
  ...
  "problemId": 139,
  "problemTitle": "139. 单词拆分",
  "category": "动态规划",
  "crux": "dp[0] 必须初始化为 true，代表空前缀视为可拆分，是所有转移的起点",
  "lang": "cpp",
  "code": "auto dp = vector <bool> (s.size() + 1);\n{{B}} // 空串视为可拆分\nfor (int i = 1; i <= s.size(); ++i) {",
  "answer": "dp[0] = true;",
  "options": [
   "dp[0] = true;",
   "dp[0] = false;",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "if (dp[j] && wordDictSet.find(s.substr(j, {{B}})) != wordDictSet.end()) {",
  "answer": "i - j",
  "options": [
   "i - j",
   "i",
 ...
 },
 {
  ...
  "problemId": 300,
  "problemTitle": "300. 最长递增子序列",
  "category": "动态规划",
  "crux": "二分查找的循环条件用 <= 而不是 <，闭区间 [l, r] 需要在 l==r 时仍检查该位置",
  "lang": "cpp",
  "code": "int l = 1, r = len, pos = 0; // 如果找不到说明所有的数都比 nums[i] 大，此时要更新 d[1]，所以这里将 pos 设为 0\nwhile ({{B}}) {\n    int mid = (l + r) >> 1;",
  "answer": "l <= r",
  "options": [
   "l <= r",
   "l < r",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "d[{{B}}] = nums[i]; // 替换第一个 >= nums[i] 的位置，让末尾尽量小",
  "answer": "pos + 1",
  "options": [
   "pos + 1",
   "pos",
 ...
 },
 {
  ...
  "problemId": 152,
  "problemTitle": "152. 乘积最大子数组",
  "category": "动态规划",
  "crux": "maxF/minF/ans 必须用 nums[0] 初始化，不能用 0 或 INT_MIN",
  "lang": "cpp",
  "code": "long maxF = {{B}}, minF = nums[0], ans = nums[0];",
  "answer": "nums[0]",
  "options": [
   "nums[0]",
   "0",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "for (int i = {{B}}; i < nums.size(); ++i) {",
  "answer": "1",
  "options": [
   "1",
   "0"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "maxF = max(mx * nums[i], max((long)nums[i], {{B}}));",
  "answer": "mn * nums[i]",
  "options": [
   "mn * nums[i]",
   "mx * nums[i]",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "minF = min(mn * nums[i], min((long)nums[i], {{B}} * nums[i]));",
  "answer": "mx",
  "options": [
   "mx",
   "maxF"
 ...
 },
 {
  ...
  "problemId": 32,
  "problemTitle": "32. 最长有效括号",
  "category": "动态规划",
  "crux": "遍历下标必须从 1 开始，不能从 0 开始，也不能跳过 1",
  "lang": "cpp",
  "code": "int maxans = 0, n = s.length();\nvector<int> dp(n, 0);\nfor (int {{B}}; i < n; i++) {\n    if (s[i] == ')') {",
  "answer": "i = 1",
  "options": [
   "i = 1",
   "i = 0",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "dp[i] = dp[i - 1] + ({{B}} ? dp[i - dp[i - 1] - 2] : 0) + 2; // 情况 \"...))\"：跨过内层有效段 dp[i-1] 找配对的 '('",
  "answer": "(i - dp[i - 1]) >= 2",
  "options": [
   "(i - dp[i - 1]) >= 2",
   "(i - dp[i - 1]) >= 1"
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "                dp[i][j] = {{B}} + grid[i][j]; // 取上、左更小的一条路",
 ...
 },
 {
  ...
  "problemId": 5,
  "problemTitle": "5. 最长回文子串",
  "category": "多维动态规划",
  "crux": "expandAroundCenter 循环左边界判断",
  "lang": "cpp",
  "code": "    while ({{B}} && right < s.size() && s[left] == s[right]) {\n        --left;\n        ++right;\n    }",
  "answer": "left >= 0",
  "options": [
   "left >= 0",
   "left > 0",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "    while (left >= 0 && {{B}} && s[left] == s[right]) {\n        --left;\n        ++right;\n    }",
  "answer": "right < s.size()",
  "options": [
   "right < s.size()",
   "right >= s.size()",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "        return {{B}}; // 退出时多扩了一步，往回收一格才是回文边界",
 ...
 },
 {
  ...
  "crux": "偶数长度中心的第二个参数",
  "lang": "cpp",
  "code": "            auto [left1, right1] = expandAroundCenter(s, i, i);     // 奇数长度：单字符中心\n            auto [left2, right2] = expandAroundCenter(s, i, {{B}}); // 偶数长度：双字符中心",
  "answer": "i + 1",
  "options": [
   "i + 1",
   "i + 2",
 ...
 },
 {
  ...
  "problemId": 1143,
  "problemTitle": "1143. 最长公共子序列",
  "category": "多维动态规划",
  "crux": "dp 数组要开 (m+1)x(n+1)，多一行一列表示空串前缀",
  "lang": "cpp",
  "code": "int m = text1.length(), n = text2.length();\nvector<vector<int>> dp({{B}}); // dp[i][j]：text1 前 i 个与 text2 前 j 个的 LCS 长度",
 ...
 },
 {
  ...
  "problemId": 169,
  "problemTitle": "169. 多数元素",
  "category": "技巧",
  "crux": "先自减再比较是否小于 0(判断票数是否真正耗尽为负),而非先比较原值或用 <=0/不减法",
  "lang": "cpp",
  "code": "if (num == candidate)\n    ++count;\nelse if ({{B}}) { // 票数被抵消耗尽，换当前元素当候选人\n    candidate = num;\n    count = 1;\n}",
  "answer": "--count < 0",
  "options": [
   "--count < 0",
   "count-- < 0",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "else if (--count < 0) { // 票数被抵消耗尽，换当前元素当候选人\n    candidate = num;\n    count = {{B}};\n}",
  "answer": "1",
  "options": [
   "1",
   "0",
 ...
 },
 {
  ...
  "problemId": 75,
  "problemTitle": "75. 颜色分类",
  "category": "技巧",
  "crux": "p2 初始值必须是 n - 1（最后一个合法下标），不是 n",
  "lang": "cpp",
  "code": "int p0 = 0, p2 = {{B}}; // 不变量：[0,p0) 全为 0，(p2,n-1] 全为 2",
  "answer": "n - 1",
  "options": [
   "n - 1",
   "n",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "while (i <= p2 && nums[i] == 2) { // 换回来的可能还是 2，必须继续换\n                {{B}}\n            }",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "while (i >= 0 && {{B}}) { // 从后往前找第一个升序对 nums[i] < nums[i+1]\n            i--;\n        }",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "while (j >= 0 && {{B}}) { // 在降序后缀里找第一个比 nums[i] 大的数\n                j--;\n            }\n            swap(nums[i], nums[j]);",
 ...
 },
 {
  ...
  "lang": "cpp",
  "code": "swap(nums[i], nums[j]);\n        }\n        reverse(nums.begin() + {{B}}, nums.end()); // 降序后缀反转成升序，保证增量最小",
  "answer": "i + 1",
  "options": [
   "i + 1",
   "i",
